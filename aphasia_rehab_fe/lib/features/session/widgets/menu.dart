...
Widget _drinksColumn(String section, String heading) {
  final items = bobsEateryMenu.entries
      ...
      .map(
        (e) => Text(
          '${e.value.name} · ${e.value.price.toStringAsFixed(e.value.price == e.value.price.roundToDouble() ? 0 : 1)}',
        ),
      )
      .toList();
  return Column(
          ...
          child: SafeArea(
            ...
            child: Stack(
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.fromLTRB(24, 24 + 40, 24, 0),
                ...
                Positioned(
                  // bottom rectangle for the hint, mic, and menu buttons
                  bottom: 0,
                  left: 0,
                  right: 0,
                  child: Container(
